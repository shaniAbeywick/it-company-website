        ...
        <>
            <nav className="bg-blue-100 border-gray-200 dark:bg-gray-900">
                <div className="lg:container p-10">
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between lg:p-4">
                        {/* Logo image */}
                        ...
                        <div className="hidden w-full lg:block lg:w-auto" id="navbar-default">
                            <ul className="font-medium flex flex-col justify-center items-baseline p-4 lg:p-0 mt-4 border-0 shadow-lg lg:shadow-none rounded-lg bg-blue-200 lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 lg:border-0 lg:bg-blue-100 dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
                                <li>
                                    <a
                                        href="/"
                                        className="block py-2 px-3 text-white text-base lg:hover:text-white hover:scale-110 active:scale-110 focus:scale-110  lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800 bg-transparent rounded lg:bg-transparent lg:p-0 dark:text-white lg:dark:text-blue-500"
                                    >Home</a>
                                </li>
                                <li>
                                    <a href="/about" className={`block py-2 px-3 text-white lg:hover:text-white  hover:scale-110 active:scale-110 focus:scale-110 lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800 text-base rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent ${pathname == "/about" ? "text-blue-300" : ""}`}>About</a>
                                </li>
                                <li>
                                    <a href="/service" className="block py-2 px-3 text-white lg:hover:text-white hover:scale-110 active:scale-110 focus:scale-110 lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800 text-base rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0  lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Service</a>
                                </li>
                                <li>
                                    <a href="/careers" className="block py-2 px-3 text-white lg:hover:text-white hover:scale-110 active:scale-110 focus:scale-110 lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800text-base rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Career</a>
                                </li>
                                {/* contact us button of nav link */}
                                <li className="hidden lg:block">
                                    <a href="/contact" className="block py-2 p-2 text-white lg:hover:text-white  hover:scale-110 active:scale-110 focus:scale-110 lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800 bg-transparent border-2 border-white rounded-sm hover:bg-gray-100 lg:hover:bg-transparent dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent focus:outline-none focus:ring-0">
                                        Contact Us
                                    </a>
                                </li>
                                {/* contact us for mobile view */}
                                <li className="lg:hidden">
                                    <a href="/contact" className="block py-2 px-3 text-white lg:hover:text-white  hover:scale-110 active:scale-110 focus:scale-110 lg:active:text-white lg:focus:text-white hover:text-gray-800 active:text-gray-800 focus:text-gray-800 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0  lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent focus:outline-none focus:ring-0 focus:border-0">
                                        Contact Us
                                    </a>
                                </li>
                            </ul>

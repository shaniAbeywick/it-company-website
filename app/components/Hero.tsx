          ...
          <div className="max-w-full flex flex-wrap items-center justify-between md:p-4">
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
              <ul className="font-medium flex flex-col md:justify-center md:items-center p-4 md:p-0 mt-4 border-0 rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <a href="/" className="block py-2 px-3 text-white rounded-none hover:bg-purple-300 md:hover:bg-transparent md:text-white md:p-0 dark:text-white md:dark:text-blue-500 md:hover:text-blue-950">Home</a>
                </li>
                <li>
                  <a href="/about" className="block py-2 px-3 text-white rounded-none hover:bg-purple-300 md:hover:bg-transparent md:border-0 md:hover:text-blue-300 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">About</a>
                </li>
                <li>
                  <a href="/service" className="block py-2 px-3 text-white rounded-none hover:bg-purple-300 md:hover:bg-transparent md:border-0 md:hover:text-blue-300 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
                </li>
                {/* <li>
                                <a href="/career" className="block py-2 px-3 text-white rounded-none hover:bg-purple-300 md:hover:bg-transparent md:border-0 md:hover:text-blue-300 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Career</a>
                            </li> */}
                <li>
